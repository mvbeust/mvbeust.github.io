...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
  ...
  function(a) {
    a.fn.parallax = function() {
      ...
      return this.each(function(c) {
        function d(c) {
          var d;
          d = 601 > b ? e.height() > 0 ? e.height() : e.children("picture").height() : e.height() > 0 ? e.height() : 500;
          var f = e.children("picture").first(),
            g = f.height(),
            h = g - d,
            i = e.offset().top + d,
            j = e.offset().top,
        ...
        var e = a(this);
        e.addClass("parallax"), e.children("picture").one("load", function() {
          d(!0)
        }).each(function() {
  ...
  function(a) {
    a(document).ready(function() {
      a.fn.reverse = [].reverse, a(document).on("mouseenter.fixedActionBtn", "a.btn-floating", function() {
        var b = a(this);
      ...
      }), a(document).on("mouseleave.fixedActionBtn", "a.btn-floating", function() {
        var b = a(this);
  ...
  function(a) {
    a(document).ready(function() {
      a.fn.reverse = [].reverse, a(document).on("mouseenter.fixedActionBtn", "a.btn-floating", function() {
        var b = a(document);
        b.find("ul div.card-floating").velocity({
          scaleY: ".4",
          scaleX: ".4",
          translateY: "40px",
        }, {
        ...
        var c = 0;
        b.find("ul div.card-floating").reverse().each(function() {
          a(this).velocity({
            opacity: "1",
        ...
        var b = a(document);
        b.find("ul div.card-floating").velocity("stop", !0), b.find("ul div.card-floating").velocity({
          opacity: "0",
          display: "none",
          scaleX: ".4",
          scaleY: ".4",
